![header](https://capsule-render.vercel.app/api?type=waving&color=gradient&height=250&section=header&text=SUB_CODE&fontSize=90)
...
- 성능 최적화 (CDN 설정, 이미지 최적화, 로딩 속도 개선)
- React Query와 상태 관리를 통한 효율적인 데이터 핸들링
- MSW를 활용한 프론트엔드 개발 환경 구축
...
<a href="https://sub-log.vercel.app/" target="_blank">
  <img align="left" alt="SOKURI_CODE | Blog" width="48px" src="https://cdn-icons-png.flaticon.com/512/60/60736.png" />
</a>
